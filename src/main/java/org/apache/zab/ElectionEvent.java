...
/**
 * A helper class that will be blocked until the leader is elected.
 */
public class ElectionEvent implements Election.ElectionCallback {

  private String electedLeader;
  private CountDownLatch condition = new CountDownLatch(1);
